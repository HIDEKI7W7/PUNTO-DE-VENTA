...
<head>
    ...
    <meta name="author" content="Hide.dev" />
    <title>Hide.dev</title>
...
<body>
    ...
    <section class="container-fluid bg-body-secondary text-center">
        <div class="container p-5">
            ...
            <div class="">
                <a href="https://wa.me/59178680723?text=Hola%2C%20vengo%20de%20la%20p%C3%A1gina%20web%20y%20me%20gustar%C3%ADa%20solicitar%20una%20demo%20del%20sistema%20de%20Punto%20de%20Venta" role="button" class="btn btn-primary" target="_blank">Solicitar una demo</a>
            </div>
            <!---Footer--->
    <footer class="text-center text-white">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
            Copyright:
            <a class="text-white" href="#" style="text-decoration: none;">Hide.dev</a>
        </div>
        <!-- Copyright -->
    </footer>
